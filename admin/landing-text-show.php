...
?>
	    ...
	    <button style="float:right;margin-right: 3px;margin-top: 3px;" type="reset" class="btn btn-info"> Add New Landing text </button></a>
                                            ...
                                            <tr class="odd gradeX">
													...
													{ 
													 ...
													 $start_from = ($page-1) * 10; 
															 ...
															 $sql = "SELECT * FROM `gk_landing_text` where input_id != 0 order by input_id DESC limit $start_from, 10";
