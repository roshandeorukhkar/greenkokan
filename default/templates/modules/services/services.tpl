							...
							<ul class="row">
								<li class="col-sm-4">
									<div class="pic">
										...
										<a href="{$siteroot}service-details/thatte/12" class="link"></a>
										<div class="date"><div>15<span>likes</span></div></div>
										<a href="{$siteroot}service-details/thatte/12" class="fancybox zoom"><i class="fa fa-search-plus"></i></a>
									</div>
									<h3><a href="{$siteroot}service-details/thatte/12">Thatte Clinic</a></h3>
